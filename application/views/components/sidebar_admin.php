  ...
  <head>
   ...
   "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";
    ...
    <link
      ...
      integrity="sha384-lzrdBbdpDNwjjOT4FJITelfn3fQC3TWc3uzv5Hd2N+g8i6i+oZtEIVIzKG90PdpWk"
      crossorigin="anonymous"
    />
    <link
    ...
    <div class="dashboard">
      <div class="dashboard-nav">
        ...
        <nav class="dashboard-nav-list">
          ...
          <a href="<?= base_url('admin/data_karyawan'); ?>" class="dashboard-nav-item"
            ><i class="fa-solid fa-calendar-days"></i> Data Karyawan
          </a>
          <div class='dashboard-nav-dropdown'>
            <a href="#!" class="dashboard-nav-item dashboard-nav-dropdown-toggle">
               <i class="fa-solid fa-calendar-week"></i> Rekap Waktu
            </a>

            <div class='dashboard-nav-dropdown-menu'>
               <a href="<?= base_url('admin/rekap_harian'); ?>" class="dashboard-nav-dropdown-item">
                  Rekap Harian
               </a>
               <a href="<?= base_url('admin/rekap_mingguan'); ?>" class="dashboard-nav-dropdown-item">
                  Rekap Mingguan
               </a>
               <a href="<?= base_url('admin/rekap_bulanan'); ?>" class="dashboard-nav-dropdown-item">
                  Rekap Bulanan
               </a>
            </div>
